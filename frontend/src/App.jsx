...
function App() {
  ...
  const fetchData = async () => {
    ...
    setMonthlyData(Object.entries(months).map(([month_id, monthly_sales]) => ({ month_id, monthly_sales })))
    ...
    setDealSizeData(Object.entries(deals).map(([dealsize, count]) => ({ dealsize, count })))
    setLoading(false)
  }
  ...
  const productLineArray = Object.entries(productLineData).map(([productline, total_sales]) => ({ productline, total_sales }))
